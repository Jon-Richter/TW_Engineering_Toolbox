...
HTML_PATH = ASSETS_DIR / "base_plate_anchor_anchor.html"
...
class WebToolWindow(QMainWindow):
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Base Plate Design Tool")
    ...
    def export_excel(self) -> None:
        def _after(payload: Optional[Dict[str, Any]]) -> None:
            ...
            default_path = out_dir / "base_plate_design_export.xlsx"
    ...
    def save_report(self) -> None:
        def _after(payload: Optional[Dict[str, Any]]) -> None:
            ...
            out_dir = user_data_dir() / "outputs"
            out_dir.mkdir(parents=True, exist_ok=True)
            default_path = out_dir / "base_plate_design_report.html"
